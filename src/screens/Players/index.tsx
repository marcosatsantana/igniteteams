...
import { playerRemoveByGroup } from '@storage/player/playerRomoveByGroup';
...
export function Players() {
    ...
    async function handleAddPlayer() {
        ...
        try {
            ...
            fetchPlayersByTeam();
            newPlayerNameInputRef.current?.blur(); //tira o focu do input
            Keyboard.dismiss(); //da um dismiss no teclado caso esteja abertos (força)
            setNewPlayerName('');
        } catch (error) {
    ...
    async function handleGroupRemove() {
        Alert.alert('Remover', 'Deseja remover a turma?', [
            ...
            { text: 'Remover', onPress: () => groupOnRemove() }
        ])
    }
